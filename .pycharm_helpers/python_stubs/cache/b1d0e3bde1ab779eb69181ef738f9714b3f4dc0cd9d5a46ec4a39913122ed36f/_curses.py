...
_C_API = None # (!) real value is '<capsule object "_curses._C_API" at 0x7f09f23cc0f0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f09f34fab00>'

__spec__ = None # (!) real value is "ModuleSpec(name='_curses', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f09f34fab00>, origin='/usr/lib/python3.6/lib-dynload/_curses.cpython-36m-x86_64-linux-gnu.so')"
