...
openssl_md_meth_names = None # (!) real value is "frozenset({'sha1', 'sha384', 'blake2b512', 'sha3-224', 'sm3', 'whirlpool', 'ripemd160', 'shake128', 'sha224', 'sha512-256', 'sha256', 'sha3-512', 'shake256', 'md5', 'md4', 'md5-sha1', 'blake2s256', 'sha512-224', 'sha512', 'sha3-384', 'sha3-256'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f09f34afcc0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f09f34afcc0>, origin='/usr/lib/python3.6/lib-dynload/_hashlib.cpython-36m-x86_64-linux-gnu.so')"
